...
export class IdeasAndProperties {
    static get getSpottingOpportunitiesSkills() {
        return IdeasAndProperties.mapSpottingOpportunitiesSkills();
    }
    static get getCreativitySkills() {
        return IdeasAndProperties.mapCreativitySkills();
    }
    static get getVisionSkills() {
        return IdeasAndProperties.mapVisionSkills();
    }
    static get getValuingIdeasSkills() {
        return IdeasAndProperties.mapValuingIdeasSkills();
    }
    static get getEthicalAndSustainableThinkingSkills() {
        return IdeasAndProperties.mapEthicalAndSustainableThinkingSkills();
    }
